 ...
 <el-card>
    ...
    <el-table :data="orderList" border stripe>
             ...
             <el-table-column label="下单事件" prop="create_time">
                 <template v-slot:default="slot">
                        {{slot.row.create_time| dataFormat}}
                 </template>
             </el-table-column>
             <el-table-column label="操作">
                 <template v-slot:default='slot'>
                    ...
                    @click="showEditAddressBox"></el-button>
                    <!-- 物流进度 -->
...
<script>
// el-timeline-item这里多了一个timeline来设置快递线路
